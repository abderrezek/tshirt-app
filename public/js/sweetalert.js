...
window.addEventListener('confirm-checkout', function (event) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    var timerInterval, icon, title, type;
    ...
    if (!result.isDismissed) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        didOpen: function didOpen() {
          ...
          var b = sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().getHtmlContainer().querySelector('b');
