...
__webpack_require__(/*! ./clothe_alpine */ "./resources/js/clothe_alpine.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.start(); // window._ = require('lodash');
...
document.addEventListener('alpine:init', function () {
  Alpine.data('cartItems', function () {
    return {
      open: false,
      type: 'cart',
  ...
  Alpine.data('clothe', function () {
    return {
      open: false,
      clothe: -1,
      show: false,
      hideApercuRapide: function hideApercuRapide() {
        this.show = false;
      },
      showApercuRapide: function showApercuRapide(id) {
        this.show = true;
        this.clothe = id;
      },
      isShowApercuRapide: function isShowApercuRapide(id) {
      ...
      isOpenModal: function isOpenModal(id) {
        return this.open && this.clothe === id;
      }
    };
  });
  Alpine.data('panier', function () {
    return {
      code: false,
      remarque: false,
      address: false,
      ...
      toggleRemarque: function toggleRemarque() {
